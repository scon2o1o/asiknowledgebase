			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item active">
						<a href="maintainuser.jsp" class="nav-link">
							User: ${sessionScope.user.getUsername()}
		...
		<div class="d-flex" id="wrapper">
			...
			<div id="page-content-wrapper">
				...
				<div class="container-fluid" style="padding: 20px;">
					...
					<form method="post" action="EditOwnPasswordServlet" id="EditOwnPassword">
					<input hidden value="${sessionScope.user.getUsername()}" type="text" class="form-control" id="username" name="username">
