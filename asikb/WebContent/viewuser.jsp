		...
		<div class="d-flex" id="wrapper">
			...
			<div class="bg-light border-right" id="sidebar-wrapper">
				...
				<div class="list-group list-group-flush">
					<a href="users.jsp" class="list-group-item list-group-item-action bg-light">Close</a>
					<a href="changepassword.jsp" class="list-group-item list-group-item-action bg-light">Change Password</a>
					<a href="deleteuser.jsp" class="list-group-item list-group-item-action bg-light">Delete</a>
				</div>
			</div>
			<!-- /#sidebar-wrapper -->
			<!-- Page Content -->
			<div id="page-content-wrapper">
				...
				<div class="container-fluid" style="padding: 20px;">
					<h4>Update deatils for ${sessionScope.viewuser.getUsername()}</h4>
					<form method="post" action="EditUserServlet" id="EditUser">
						<div class="form-group">
							<label for="id">Username</label>
							<input value="${sessionScope.viewuser.getUsername()}" type="text" class="form-control" id="username" name="username" readonly>
						</div>
						<div class="form-group">
							<label for="id">First Name</label>
							<input value="${sessionScope.viewuser.getFirstnames()}" type="text" class="form-control" id="firstnames" name="firstnames">
						</div>
						<div class="form-group">
							<label for="id">Surname</label>
							<input value="${sessionScope.viewuser.getSurname()}" type="text" class="form-control" id="surname" name="surname">
						</div>
						<div class="form-group">
							<label for="Canadd">Allow Add New Documents</label>
							<select id="canadd" name="canadd" class="form-control">
								<option value="${sessionScope.viewuser.getCanadd()}">${sessionScope.viewuser.getCanadd()}</option>
								<c:choose>
									<c:when test="${sessionScope.viewuser.getCanadd().equals('Y')}">
										<option>N</option>
									</c:when>
									<c:otherwise>
										<option>Y</option>
						...
						<div class="form-group">
							<label for="Canedit">Allow Edit Documents</label>
							<select id="canedit" name="canedit" class="form-control">
								<option value="${sessionScope.viewuser.getCanedit()}">${sessionScope.viewuser.getCanedit()}</option>
								<c:choose>
									<c:when test="${sessionScope.viewuser.getCanedit().equals('Y')}">
										<option>N</option>
									</c:when>
									<c:otherwise>
										<option>Y</option>
						...
						<div class="form-group">
							...
							<select id="isadmin" name="isadmin" class="form-control">
								<option value="${sessionScope.viewuser.getIsadmin()}">${sessionScope.viewuser.getIsadmin()}</option>
								<c:choose>
									<c:when test="${sessionScope.viewuser.getIsadmin().equals('Y')}">
										<option>N</option>
									</c:when>
									<c:otherwise>
										<option>Y</option>
