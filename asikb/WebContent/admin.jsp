			...
			<div id="page-content-wrapper">
				...
				<div class="container-fluid" style="padding: 20px;">
					...
					<div class="row" style="text-align: center; margin-top: 30px;">
						<div class="col">
							<a href="addcategory.jsp" type="button" id="" class="btn btn-outline-link btn-lg">
						...
						<div class="col">
							<a href="editcategory.jsp" type="button" id="" class="btn btn-outline-link btn-lg">
						...
						<div class="col">
							<a href="deletecategory.jsp" type="button" id="" class="btn btn-outline-link btn-lg">
						...
						<div class="col">
							<a href="addsubcategory.jsp" type="button" id="" class="btn btn-outline-link btn-lg">
						...
						<div class="col">
							<a href="editsubcategory.jsp" type="button" id="" class="btn btn-outline-link btn-lg">
						...
						<div class="col">
							<a href="deletesubcategory.jsp" type="button" id="" class="btn btn-outline-link btn-lg">
					...
					<div class="row" style="text-align: center; margin-top: 30px;">
						<div class="col">
							<a href="users.jsp" type="button" id="" class="btn btn-outline-link btn-lg">
						...
						<div class="col">
							<a href="adduser.jsp" type="button" id="" class="btn btn-outline-link btn-lg">
						...
						<div class="col">
							<a href="audit.jsp" type="button" id="" class="btn btn-outline-link btn-lg">
						...
						<div class="col">
							<a href="smtp.jsp" type="button" id="" class="btn btn-outline-link btn-lg">
						...
						<div class="col">
							<a href="sysadmin.jsp" type="button" id="" class="btn btn-outline-link btn-lg">
						...
						<div class="col">
							<a href="LogoutServlet" type="button" id="" class="btn btn-outline-link btn-lg">
