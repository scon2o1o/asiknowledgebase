		...
		<div class="d-flex" id="wrapper">
			...
			<div class="bg-light border-right" id="sidebar-wrapper">
				...
				<div class="list-group list-group-flush">
					...
					<c:if test="${sessionScope.user.getCanedit().equals('Y')}">
						<a href="editdoc.jsp" class="list-group-item list-group-item-action bg-light">Edit</a>
						<a href="deletedoc.jsp" class="list-group-item list-group-item-action bg-light">Delete</a>
					</c:if>
				</div>
			</div>
			<!-- /#sidebar-wrapper -->
			...
			<div id="page-content-wrapper">
				...
				<div class="container-fluid" style="padding: 20px;">
					<div class="container-fluid" style="padding: 5px;">
						<div class="row">
							<div class="col-sm">
								<h3 id="title">${sessionScope.document.getDetails()}</h3>
							</div>
							<div class="col-sm" style="text-align: right;">
								<form method="post" action="LikeButtonServlet" id="">
									<input type="text" value="${sessionScope.user.getUsername()}" hidden id="username" name="username"></input>
									<input type="text" value="${sessionScope.document.getId()}" hidden id="id" name="id"></input>
									<button type="submit" id="like" class="btn btn-primary">
					...
					<iframe id="iframe" src="${sessionScope.document.getUrl()}" width="100%" height="800"></iframe>
				</div>
			</div>
