		...
		<div class="d-flex" id="wrapper">
			...
			<div id="page-content-wrapper">
				...
				<div class="container-fluid" style="padding: 20px;">
					...
					<p class="text-muted">Choose a subcategory name to edit</p>
					<form method="post" action="EditSubcategoryServlet" id="EditSubcategory">
					<div class="form-group">
							<label for="category">Subcategory</label>
							<select id="subcategory" name="subcategory" class="form-control" readonly>
								<option value=""></option>
							</select>
						</div>
						<div class="form-group">
						...
						<button class="btn btn-info" type="submit" id="submitButton">Edit</button>
					</form>
				</div>
			</div>
