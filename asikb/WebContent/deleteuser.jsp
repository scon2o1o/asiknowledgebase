		...
		<div class="d-flex" id="wrapper">
			...
			<div class="bg-light border-right" id="sidebar-wrapper">
				...
				<div class="list-group list-group-flush">
					<a href="viewuser.jsp" class="list-group-item list-group-item-action bg-light">Close</a>
				</div>
			</div>
			<!-- /#sidebar-wrapper -->
			<!-- Page Content -->
			<div id="page-content-wrapper">
				...
				<div class="container-fluid" style="padding: 20px;">
					...
					<form method="post" action="DeleteUserServlet" id="DeleteUser">
						...
						<div class="form-group">
							...
							<input value="${sessionScope.viewuser.getFirstnames()}" type="text" class="form-control" id="firstnames" name="firstnames" readonly>
						</div>
						<div class="form-group">
							<label for="surname">Surname</label>
							<input value="${sessionScope.viewuser.getSurname()}" type="text" class="form-control" id="surname" name="surname" readonly>
						</div>
