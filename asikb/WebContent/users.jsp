...
<body class="d-flex flex-column h-100">
		...
		<div class="d-flex" id="wrapper">
			...
			<div class="bg-light border-right" id="sidebar-wrapper">
				...
				<div class="list-group list-group-flush">
					...
					<a href="adduser.jsp" class="list-group-item list-group-item-action bg-light">Add New User</a>
				</div>
			</div>
			<!-- /#sidebar-wrapper -->
			<!-- Page Content -->
			<div id="page-content-wrapper">
				...
				<div class="container-fluid" style="padding: 20px;">
					...
					<div>
						<p class="text-muted">Filter the results by using the search box below. Sort the table by clicking on the individual headings</p>
						...
						<table class="table" id="usertable">
							<thead class="thead-light">
								<tr>
									...
									<th onclick="sortTable(3)" scope="col">Add Documents</th>
									<th onclick="sortTable(4)" scope="col">Edit Documents</th>
									<th onclick="sortTable(5)" scope="col">Administrator</th>
									<th scope="col"></th>
								</tr>
							</thead>
							<tbody>
	...
	<script src="js/usersearchfunction.js" type="text/javascript"></script>
	<script src="js/sortusertable.js" type="text/javascript"></script>
</body>
</html>
