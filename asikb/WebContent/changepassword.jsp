		...
		<div class="d-flex" id="wrapper">
			...
			<div id="page-content-wrapper">
				...
				<div class="container-fluid" style="padding: 20px;">
					<h4>Change password for ${sessionScope.viewuser.getUsername()}</h4>
					<form method="post" action="EditUserPasswordServlet" id="EditUserPassword">
						<div class="form-group">
							<label hidden for="id">Username</label>
							<input hidden value="${sessionScope.viewuser.getUsername()}" type="text" class="form-control" id="username" name="username" readonly>
						</div>
						<div class="form-group">
