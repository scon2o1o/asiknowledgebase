		...
		<div class="d-flex" id="wrapper">
			...
			<div id="page-content-wrapper">
				...
				<div class="container-fluid" style="padding: 20px;">
					...
					<form method="post" action="DeleteDocServlet" id="DeleteDoc">
						<input value="${sessionScope.user.getUsername()}" type="text" id="user" name="user" hidden>
						<input value="${sessionScope.document.getId()}" type="text" id="id" name="id" hidden>
						<div class="form-group">
							<label for="Username">Name</label>
							<input value="${sessionScope.document.getName()}" type="text" class="form-control" id="name" name="name" readonly>
						</div>
						<div class="form-group">
							<label for="Firstnames">Details</label>
							<input value="${sessionScope.document.getDetails()}" type="text" class="form-control" id="details" name="details" readonly>
						</div>
						<div class="form-group">
							<label for="Surname">URL</label>
							<input value="${sessionScope.document.getUrl()}" type="text" class="form-control" id="url" name="url" readonly>
						</div>
