...
<body class="d-flex flex-column h-100">
		...
		<div class="d-flex" id="wrapper">
			...
			<div class="bg-light border-right" id="sidebar-wrapper">
				...
				<div class="list-group list-group-flush">
					...
					<a class="list-group-item list-group-item-action bg-light" onclick="clearAddNewUserForm()">Clear</a>
					<a class="list-group-item list-group-item-action bg-light" onclick="submitAddNewUserForm()">Submit</a>
				</div>
			</div>
			<!-- /#sidebar-wrapper -->
			<!-- Page Content -->
			<div id="page-content-wrapper">
				...
				<div class="container-fluid" style="padding: 20px;">
					<h3>Add New User</h3>
					<form method="post" action="AddUserServlet" id="AddNewUser">
	...
	<script>
		...
		function clearAddNewUserForm() {
			...
			document.getElementById("Canadd").value = '';
